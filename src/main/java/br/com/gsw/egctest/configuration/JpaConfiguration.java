package br.com.gsw.egctest.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.gsw.egctest.repositories", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
...
public class JpaConfiguration {
	...
	factoryBean.setPackagesToScan(new String[] { "br.com.gsw.egctest.model" });
